 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Request::isApiRequest();
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function finishWith($str, $with)
        {
                        return \Illuminate\Support\Str::finishWith($str, $with);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::isEmpty($str);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Str::isNotEmpty($str);
        }
