...
final class RemoveLikeAction implements ShouldQueue, ShouldBeUnique
{
    ...
    {
        if ($userActivities->userActivityExists($this->user, $this->model, ActionType::LIKE)) {
            $activityService->removeAction($this->user, $this->model);
        }
    }
}
